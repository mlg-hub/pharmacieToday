                       ...
                       <!--    <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-12 col-xs-12 col-md-push-1">
        <input type="text" name="MESURE_PRODUCT" required pattern="[A-Za-zéèà -]+" title="<Please enter character strings only >"  value="<?php echo!empty($MESURE_PRODUCT) ? $MESURE_PRODUCT : ''; ?>" class="form-control"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5 col-sm-12 col-xs-12 col-md-push-1">
                                    <input type="text" name="PRODUIT_DESCRIPTION" required pattern="[A-Za-zéèà -]+" title="<Please enter character strings only >"  value="<?php echo!empty($PRODUIT_DESCRIPTION) ? $PRODUIT_DESCRIPTION : ''; ?>" class="form-control"> 
