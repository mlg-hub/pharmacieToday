                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12" style=" margin-bottom: 5px">
                            ...
                            <div class="row" id="conta" style="margin-top: -10px">
                                 <div class="col-lg-6 col-md-6">                                  
                                   <h4 class=""><b>Enregistrement d'un appareil</b></h4>  
                                </div>
                        ...
                        <div class="col-lg-12 jumbotron" style="padding: 5px">
                            ...
                            <form id="regiration_form" action="<?php echo base_url()?>administration/Appareils/add"  method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <label>Numero de tel</label>
                                    </div>
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 form-group">
                                        <input type="text" name="APPAREIL_NUM_TEL" id="APPAREIL_NUM_TEL" value="<?php echo !empty($APPAREIL_NUM_TEL) ? $APPAREIL_NUM_TEL : ''; ?>" placeholder="" class="form-control input-sm" >
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 form-group">
                                        <!-- <input type="text" name="AGENT_ID" id="AGENT_ID" placeholder="" class="form-control input-sm" > -->

                                        <select name="AGENT_ID" id="AGENT_ID" class="form-control input-sm">
                                            <option value="">Selectionner</option>

                                            <?php foreach ($listagent as $listsociets): ?>

                                         <?php if($listsociets['AGENT_ID'] == $AGENT_ID): ?>
                                            <option value="<?=$listsociets['AGENT_ID']?>" selected><?=$listsociets['NOM']?></option>
                                        <?php else: ?>
                                            <option value="<?=$listsociets['AGENT_ID']?>"><?=$listsociets['NOM']?></option>
                                        <?php endif; ?>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 form-group">
                                        ...
                                        <select name="SOCIETE_ID" id="SOCIETE_ID" class="form-control input-sm">
                                            ...
                                            <?php foreach ($listsociet as $listsociets): ?>

                                         <?php if($listsociets['SOCIETE_ID'] == $SOCIETE_ID): ?>
                                            <option value="<?=$listsociets['SOCIETE_ID']?>" selected><?=$listsociets['SOCIETE_NOM']?></option>
                                        <?php else: ?>
                                            <option value="<?=$listsociets['SOCIETE_ID']?>"><?=$listsociets['SOCIETE_NOM']?></option>
                                        <?php endif; ?>
