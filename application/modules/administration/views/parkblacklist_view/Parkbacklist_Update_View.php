                    ...
                    <div class="row">
                        <div class="col-lg-12" style=" margin-bottom: 5px">
                            ...
                            <div class="row" id="conta" style="margin-top: -10px">
                                 <div class="col-lg-6 col-md-6">                                  
                                   <h4 class=""><b>Modification la Liste noire dans parking </b></h4>  
                        ...
                        <div class="col-lg-12 jumbotron table-responsive" style="padding: 5px">
                          <!--?= $this->session->flashdata('message') ?-->
                             <form   id="myform" method="POST" class="form-horizontal" action="<?php echo base_url() ?>administration/Parkbacklist/update/" accept-charset="utf-8" enctype="multipart/form-data">

         <div class="row">
              <!-- <div class="col-md-12 sm-12 xs-12 form-group">
                <div id="message_affiche" class="message_affiche"></div>
              </div> -->
        <input type="hidden" name="BLACK_LIST_ID" value="<?= $row['BLACK_LIST_ID']?>">
         <div class="form-group">
               <label for="" class="col-md-3 col-sm-12 col-xs-12 control-label">Plaque du véhicule</label>
                          <div class="col-md-5 col-sm-12 col-xs-12 col-md-push-1">
                             <input type="text" class="form-control" name="PLAQUE_VEHICULE" id="PLAQUE_VEHICULE" value="<?= $row['PLAQUE_VEHICULE']?>">
          ...
          <div class="form-group">
              ...
              <label for="" class="col-md-3 col-sm-12 col-xs-12 control-label">Type violation</label>
         ...
         <div class="form-group">
              ...
              <label for="" class="col-md-3 col-sm-12 col-xs-12 control-label">Propriétaire du véhicule</label>
                          <div class="col-md-5 col-sm-12 col-xs-12 col-md-push-1">
                             <input type="text" class="form-control" name="PROPRIETAIRE" id="PROPRIETAIRE" value="<?= $row['PROPRIETAIRE']?>">
         ...
         <div class="form-group">
              ...
              <label for="" class="col-md-3 col-sm-12 col-xs-12 control-label">Numéro de téléphone</label>
                          <div class="col-md-5 col-sm-12 col-xs-12 col-md-push-1">
