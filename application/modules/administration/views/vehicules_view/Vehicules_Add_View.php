            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" style=" margin-bottom: 5px">
                        ...
                        <div class="row" id="conta" style="margin-top: -10px">
                            <div class="col-lg-6 col-md-6">
                                <h4 class=""><b>Enregistrement d'un vehicule</b></h4>
                            </div>
                    ...
                    <div class="col-lg-12 jumbotron" style="padding: 5px">
                        ...
                        <form id="regiration_form" action="<?php echo base_url() ?>administration/Vehicule/add"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 form-group">
                                    <input type="text" name="VEHICULE_PLAQUE" id="VEHICULE_PLAQUE"
                                           value="<?php echo !empty($VEHICULE_PLAQUE) ? $VEHICULE_PLAQUE : ''; ?>"
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 form-group">
                                    <input type="text" name="VEHICULE_NOM_PROPRIETAIRE" id="VEHICULE_NOM_PROPRIETAIRE"
                                           value="<?php echo !empty($VEHICULE_NOM_PROPRIETAIRE) ? $VEHICULE_NOM_PROPRIETAIRE : ''; ?>"
                                           placeholder="" class="form-control input-sm">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 form-group">
                                    <input type="text" name="VEHICULE_PRENOM_PROPRIETAIRE"
                                           id="VEHICULE_PRENOM_PROPRIETAIRE"
                                           value="<?php echo !empty($VEHICULE_PRENOM_PROPRIETAIRE) ? $VEHICULE_PRENOM_PROPRIETAIRE : ''; ?>"
                                           placeholder="" class="form-control input-sm">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 form-group">
                                    <input type="text" name="VEHICULE_TEL_PROPRIETAIRE" id="VEHICULE_TEL_PROPRIETAIRE"
                                           value="<?php echo !empty($VEHICULE_TEL_PROPRIETAIRE) ? $VEHICULE_TEL_PROPRIETAIRE : ''; ?>"
                                           placeholder="" class="form-control input-sm">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 form-group">
                                    <input type="text" name="VEHICULE_EMAIL_PROPRIETAIRE"
                                           id="VEHICULE_EMAIL_PROPRIETAIRE"
                                           value="<?php echo !empty($VEHICULE_EMAIL_PROPRIETAIRE) ? $VEHICULE_EMAIL_PROPRIETAIRE : ''; ?>"
                                           placeholder="" class="form-control input-sm">
                                </div>
